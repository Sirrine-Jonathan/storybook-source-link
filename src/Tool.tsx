...
import { Icons, IconButton, TooltipMessage, WithTooltip, IconType } from "@storybook/components";
...
export const Tool = () => {
  ...
  let param_icon = useParameter(ICON_PARAM_KEY, "repository") as IconType;
